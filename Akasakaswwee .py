...
\033[1;37m    ######      ######     ########  
\033[1;37m------------------------------------------------
\033[1;37m Owner   :            AKASH ON FIRE 
\033[1;37m Facebook:            Akashonfire
\033[1;37m Github  :            akash123
\033[1;37m Version :            20.9
\033[1;37m------------------------------------------------ """
def clear():
    os.system("clear")
    print(logo)    
...
def sarfraz():   
    ...
    if select =='1':
       ...
       cutter()
        ...
        os.system('xdg-open https://www.facebook.com/profile.php?id=100078014552659')
        pass
    elif select =='F':
        os.system('xdg-open https://www.facebook.com/profile.php?id=100078014552659 /')
    else:
